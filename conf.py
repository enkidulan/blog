...
# Enkidulan's blog build configuration file, created by
# `ablog start` on Sun Jul 16 20:19:37 2023.
#
...
blog_title = "Enkidulan's blog Blog"

# Base URL for the website, required for generating feeds.
# e.g. blog_baseurl = "http://example.com/"
blog_baseurl = "https://enkidulan.info/"
...
blog_authors = {
    "Maksym Shalenyi": ("Maksym Shalenyi", None),
}
